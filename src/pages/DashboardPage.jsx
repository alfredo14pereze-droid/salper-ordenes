    ...
    <div className="page">
      <div className="section-header">
        ...
        {/* V34: "Órdenes pasadas" y "Control rápido" dejaron de ser links
            ...
            aquí, como botones dentro del propio Dashboard. "Resumen" y
            "Estadísticas" se sumaron después con el mismo criterio (pedido
            del usuario). */}
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          {!tiendaBasica && (
            <Link to="/estadisticas" className="btn btn--ghost btn--small">
              Estadísticas
            </Link>
          )}
