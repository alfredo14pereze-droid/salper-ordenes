    ...
    <div className="page">
      <div className="section-header">
        ...
        {/* V34: "Órdenes pasadas" y "Control rápido" dejaron de ser links
            ...
            sumó después con el mismo criterio. "Estadísticas" pasó por
            aquí en V35 pero V36 la subió a su propia pestaña del menú
            lateral (pedido del usuario) — ya no vive en este grupo. */}
